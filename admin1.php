...
<h3 class="cd"><b><u>Student Details</u></b></h3>
 ...
 <?php
      if($_SESSION['user']!=NULL)
      {
          ...
          if($rcheck>0)
            {
                echo "<br>";
                echo "<table><tr><th>Id</th><th>First Name</th><th>Last Name</th><th>Father Name</th><th>Mother Name</th><th>Address</th>
                <th>Marks(last exam)</th><th>Rank</th><th>Email-id</th><th>Password</th><th>Mobile No</th><th>Religion</th><th>Gender</th><th>Birthday</th></tr>";
                while ($row= mysqli_fetch_assoc($result))
                {
                    echo "<tr><td>".$row['id']."</td><td>".$row['First_name']."</td><td>".$row['Last_name']."</td><td>".$row['Father_name']."</td><td>".$row['Mother_name']."</td><td>".$row['Address']."</td>
                    <td>".$row['Marks_last_exam']."</td><td>".$row['Rank_WBJEE_MAIN']."</td><td>".$row['Email_id']."</td><td>".$row['Password']."</td><td>".$row['Mobile_No']."</td><td>".$row['Religion']."</td><td>".$row['Gender']."</td><td>".$row['Birthday']."</td></tr>";
                }
                echo "</table>";
            } 
           else
